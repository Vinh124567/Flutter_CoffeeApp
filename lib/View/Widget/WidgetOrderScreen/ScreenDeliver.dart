...
//   const Deliver({Key? key, required this.coffees}) : super(key: key);
//
//   @override
...
//   Map<Coffee, int> coffeeQuantities = {}; // Số lượng của từng sản phẩm
//
//   @override
//   void initState() {
//     super.initState();
//     // Khởi tạo số lượng của từng sản phẩm là 1
//     coffeeQuantities = {for (var coffee in widget.coffees) coffee: 1};
//   }
//
//   @override
...
//                           Text(
//                               "Phone: ${_selectedAddress!.phone ?? 'Unknown'}"),
//                           Text(
...
//                     final quantity = coffeeQuantities[coffee] ?? 1;
//                     return Row(
//                       children: [
//                         ClipRRect(
...
//                                 coffeeQuantities[coffee] = quantity + 1;
//                               }
//                             });
//                           },
...
//                           ),
//                         ),
//                         Text(quantity.toString()), // Hiển thị số lượng hiện tại
//                         ElevatedButton.icon(
//                           onPressed: () {
//                             setState(() {
//                               if (quantity > 1) {
...
//
//     for (var coffee in widget.coffees) {
//       final quantity = coffeeQuantities[coffee] ?? 1;
